...
use App\Services\TravelRadiusService;
use Exception;
use Illuminate\Database\Eloquent\ModelNotFoundException;
use Illuminate\Http\Request;

class TravelRadiusController extends Controller
{
     protected $service;

    public function __construct(TravelRadiusService $service)
    {
    ...
    public function index(Request $request)
    {
        ...
        return view('travel-radius.index', compact('data', 'search'));
    }
