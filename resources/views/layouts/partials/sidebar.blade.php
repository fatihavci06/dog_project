<ul class="navbar-nav bg-neon-dark sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('dashboard') }}">
        <div class="sidebar-brand-icon rotate-n-15">
            <i class="fas fa-paw text-neon-blue fa-bounce"></i>
        </div>
    ...
    <li class="nav-item">
        ...
        <div id="collapseff" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-dark-light py-2 collapse-inner rounded">
                ...
                <a class="collapse-item text-white" href="{{ url('/LookingFor') }}">Looking For</a>
                <a class="collapse-item text-white" href="{{ url('/Vibe') }}">Vibe</a>
                <a class="collapse-item text-white" href="{{ url('/HealthInfo') }}">Health Info</a>
...
<style>
    ...
    .sidebar .nav-item .nav-link {
        color: #b2b2b2;
        /* Menü metni için açık gri */
        transition: all 0.3s ease;
    }

    .sidebar .nav-item .nav-link:hover {
        background-color: rgba(0, 255, 255, 0.1);
        /* Neon Mavisi şeffaf hover */
        color: #00FFFF;
        /* Metin rengini neon mavi yap */
        box-shadow: inset 5px 0 0 #00FFFF;
        /* Solunda neon mavi çizgi */
        border-radius: 5px;
    }
    ...
    .sidebar .nav-item.active .nav-link {
        ...
        /* Neon Yeşil şeffaf arkaplan */
        color: #39FF14;
        /* Neon Yeşil metin */
        font-weight: bold;
        box-shadow: inset 5px 0 0 #39FF14;
        /* Solunda neon yeşil çizgi */
        border-radius: 5px;
    }
