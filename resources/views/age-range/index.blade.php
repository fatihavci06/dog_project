...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex justify-content-between align-items-center">
            <h6 class="m-0 font-weight-bold text-primary">Age Range List</h6>
        ...
        <div class="modal-dialog">
            <form id="addForm" class="modal-content">
                ...
                <div class="modal-body">
                    <input type="text" name="name" class="form-control" placeholder="Age Range " required>
                </div>
    ...
    <div class="modal fade" id="editModal" tabindex="-1">
        <div class="modal-dialog">
            <form id="editForm" class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">Edit Age Range</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.deleteBtn').forEach(btn=>{
        btn.addEventListener('click', ()=>{
            ...
            Swal.fire({
                title: 'Are you sure?',
                text: "This will delete the age range permanently!",
                icon: 'warning',
