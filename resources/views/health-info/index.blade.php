...
@section('title', 'Health Info List')
@section('content')
    @if (session('success'))
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex justify-content-between align-items-center">
            <h6 class="m-0 font-weight-bold text-primary">Health Info List</h6>
        ...
        <div class="modal-dialog">
            <form id="addForm" class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Add Health Info</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
                    <input type="text" name="name" class="form-control" placeholder="Health Info " required>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.deleteBtn').forEach(btn=>{
        btn.addEventListener('click', ()=>{
            ...
            Swal.fire({
                title: 'Are you sure?',
                text: "This will delete the health info permanently!",
                icon: 'warning',
