...
@section('title', 'Availability For Meetups')
@section('content')
    @if (session('success'))
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex justify-content-between align-items-center">
            <h6 class="m-0 font-weight-bold text-primary">Availability For Meetups</h6>
        ...
        <div class="modal-dialog">
            <form id="addForm" class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Add Availability For Meetups</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
                    <input type="text" name="name" class="form-control" placeholder="Availability For Meetups" required>
                </div>
    ...
    <div class="modal fade" id="editModal" tabindex="-1">
        <div class="modal-dialog">
            <form id="editForm" class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">Edit Availability For Meetups</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('addForm').addEventListener('submit', function(e){
        ...
        fetch('{{ route('availabilityForMeetups.store') }}', {
            method: 'POST',
    ...
    document.getElementById('editForm').addEventListener('submit', function(e){
        ...
        let formData = new FormData(this);
        fetch(`/availability-for-meetups/update/${id}`, {
            method: 'POST',
            headers: {
    ...
    document.querySelectorAll('.deleteBtn').forEach(btn=>{
        btn.addEventListener('click', ()=>{
            ...
            Swal.fire({
                title: 'Are you sure?',
                text: "This will delete the availability for meetups permanently!",
                icon: 'warning',
                ...
                if(result.isConfirmed){
                    fetch(`/availability-for-meetups/delete/${id}`, {
                        method:'POST',
                        headers:{
                            'X-CSRF-TOKEN':'{{ csrf_token() }}',
